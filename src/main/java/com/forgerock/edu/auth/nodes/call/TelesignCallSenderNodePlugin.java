...
public class TelesignCallSenderNodePlugin extends AbstractNodeAmPlugin {
    ...
    protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
        return Collections.singletonMap(TelesignCallSenderNodePlugin.currentVersion,
                Collections.singletonList(TelesignCallSenderNode.class));
    }
    ...
    public String getPluginVersion() {
        return TelesignCallSenderNodePlugin.currentVersion;
    }
}
