...
public class SavePhoneNodePlugin extends AbstractNodeAmPlugin {
    ...
    protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
        return Collections.singletonMap(SavePhoneNodePlugin.currentVersion,
                Collections.singletonList(SavePhoneNode.class));
    }
    ...
    public String getPluginVersion() {
        return SavePhoneNodePlugin.currentVersion;
    }
}
