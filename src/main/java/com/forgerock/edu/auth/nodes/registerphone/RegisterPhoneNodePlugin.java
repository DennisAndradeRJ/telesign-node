...
public class RegisterPhoneNodePlugin extends AbstractNodeAmPlugin {
    ...
    protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
        return Collections.singletonMap(RegisterPhoneNodePlugin.currentVersion,
                Collections.singletonList(RegisterPhoneNode.class));
    }
    ...
    public String getPluginVersion() {
        return RegisterPhoneNodePlugin.currentVersion;
    }
}
